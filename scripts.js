window.writeValues = function(form) {
    ...
    document.getElementById('email-txt').innerHTML = '<a href="mailto:' + email + '">' + email + "</a>"  + '<br><br>' + photo.value + "<br><br>" + '<span style="color:#004080; font-weight:bold">' + "Unum Życie TUiR S.A.</span><br><span>al. Jana Pawła II 17, 00-854 Warszawa, Polska</span>";
